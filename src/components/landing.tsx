...
const Landing = () => {
    ...
    return ( 
        <React.Fragment>
            ...
            <Typography variant="h1" style={{fontWeight: 700}}><span className="text-blue-500">Hari</span>krishna Vardhineedi</Typography>

            <Typography variant="h3" style={{fontWeight: 700}}>Student with a passion for <u><span className="text-blue-500">full-stack</span></u><br/> and <u><span className="text-blue-500">distributed systems</span></u></Typography>
