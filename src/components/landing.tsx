...
const Landing = () => {
    ...
    return ( 
        <React.Fragment>
            ...
            <Typography variant="h3" style={{fontWeight: 700}}>Student with a passion for <u><span className="text-blue-500">full-stack</span></u><br/> and <u><span className="text-blue-500">cloud systems</span></u></Typography>
