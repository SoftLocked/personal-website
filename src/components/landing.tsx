...
const Landing = () => {
    ...
    return ( 
        <React.Fragment>
            ...
            <Typography sx={{ typography: { md: 'h3', sm: 'h4', xs: 'h5' } }} style={{fontWeight: 700}}>Student with a passion for <u><span className="text-blue-500">fullstack</span></u><br/> and <u><span className="text-blue-500">cloud systems</span></u></Typography>
